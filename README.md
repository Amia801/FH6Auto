...
> 基于 [YOUSTHEONE/FH6Auto](https://github.com/YOUSTHEONE/FH6Auto) 的个人修改版。  
> 改动：支持 UI 配置每局技能点；默认蓝图 `338929569`、默认每局 50 技能点；默认调校 **834 分 / 限速一档 115**（改车码 `123675780`）。
...
- 导入改车码 **`123675780`**（评分 **834**，限速一档 **115**）
- 将该车辆加入收藏
- 不要有任何涂装

> **说明：** 脚本**不会**强制固定某一套地图或调校。跑图用的**蓝图代码**可在程序界面「循环跑图」模块里随时修改；车辆调校也只需你在游戏内自行更换改车码并重新收藏对应车辆即可，无需改代码。
